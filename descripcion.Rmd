...
kable_styling(column_spec(kable(addmargins(table(datos$dificultades_trabajo)), caption = "Dificultades para el trabajo (absolutos)", col.names = 
                      c("dificultades", "casos")),
                    1, width = "13cm"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$dificultad_trabajo_1, datos$nse),2),2),1),3), caption = "Dificultad para el trabajo (1) (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$dificultad_trabajo_1, datos$nse)), caption = "Dificultad para el trabajo (1) (absolutos)"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$dificultad_trabajo_2, datos$nse),2),2),1),3), caption = "Dificultad para el trabajo (2) (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$dificultad_trabajo_2, datos$nse)), caption = "Dificultad para el trabajo (2) (absolutos)"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$dificultad_trabajo_3, datos$nse),2),2),1),3), caption = "Dificultad para el trabajo (3) (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$dificultad_trabajo_3, datos$nse)), caption = "Dificultad para el trabajo (3) (absolutos)"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$dificultad_trabajo_4, datos$nse),2),2),1),3), caption = "Dificultad para el trabajo (4) (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$dificultad_trabajo_4, datos$nse)), caption = "Dificultad para el trabajo (4) (absolutos)"), latex_options = "HOLD_position")
```

...
names(datos)<-c("encuestador", "NSSE", "edad", "genero", "tiene_DNI", "procedencia",
"estado_civil", "tiene_electricidad", "tiene_gas_natural", "tiene_gas_envasado",
"tiene_agua_potable", "tiene_cloacas", "como_calefacciona",
"tiene_aire_acondicionado", "cantidad_integrantes_con_cobertura_salud",
"cobertura_salud", "alcance_cobertura_salud", "tiene_servicio_emergencia",
"tiene_ambulancia", "tiene_tel_fijo", "tiene_celular", "tiene_internet",
"cambio_acceso_internet", "tiene_PC", "tiene_notebook", "tiene_notebook_CI", 
"tiene_tablet", "tiene_smart_TV", "tiene_impresora", "tene_camara_fotos", 
"cuantos_celulares", "compro_dispositivo_ultimo_anio", "ingresos_del_hogar",
"fuente_ingresos", "estabilidad_ingresos", "variacion_ingresos_pandemia",
"prestaciones_estatales", "alguien_trabaja_formal", "alguien_trabaja_informal", 
"alguien_trabaja_cuentapropia", "alguien_trabaja_changas", 
"alguien_trabaja_negocio_propio", "alguien_no_trabaja_y_busca",
"origen_ingreso_principal", "intensidad_ingreso_principal", 
"prestaciones_estatales_pandemia", "empleo_en_pandemia",
"suficiencia_ingresos_pre_pandemia", 
"suficiencia_ingresos_en_pandemia", "conformidad_laboral_pre_pandemia",
"conformidad_laboral_pandemia", "dificultades_empleo_pandemia",
"solicitud_ayuda_pandemia", "difultad_actividades_pandemia", 
"credito_pandemia", "atencion_salud_tipo", "atencion_salud_distancia",
"atencion_salud_movilidad", "atencion_salud_dificultades_pre_pandemia",
"atencion_salud_durante_pandemia", "atencion_salud_dificultades_pandemia", 
"pandemia_responsabilidad", "atencion_salud_dificultades_pre_pandemia_detalle",
"covid_positivo", "covid_positivo_dificultades",
"atencion_salud_acceso_informacion", "atencion_salud_acceso_informacion_origen", 
"educ_hogar_inicial", "educ_hogar_primario", "educ_hogar_secundario",
"educ_hogar_universitario", "educ_hogar_inicial_establecimiento",
"educ_hogar_primario_establecimiento", "educ_hogar_secundario_establecimiento",
"educ_hogar_universitario_establecimiento", "educ_hogar_inicial_distancia",
"educ_hogar_primario_distancia", "educ_hogar_secundario_distancia",
"educ_hogar_universitario_distancia", "educ_hogar_inicial_movilidad",
"educ_hogar_primario_continuidad", "educ_hogar_secundario_continuidad", 
"educ_hogar_universitario_continuidad", "educ_hogar_inicial_medios",
"informacion_medidas_educativas_origen", "fecha", "hora", "id_encuesta",
"vivienda_tipo", "vivienda_ambientes", "vivienda_habitacion", "vivienda_tenencia",
"vivienda_grupos", "vivienda_miembros", "jefx_hogar", "cant_menores_14",
"cant_14_60", "cant_mas_60", "cant_perceptores", "cant_perceptores_varon",
"cant_perceptores_mujer", "cant_estudia", "menores_estudia", "discapacidad",
"discapacidad_certificado", "discapacidad_pension", "nombre", "telefono",
"residencia", "cant_varones", "cant_mujeres", "cant_educ_inicial",
"cant_educ_primaria", "cant_educ_secundaria", "cant_educ_universitaria", 
"barrio", "nro_orden_hogar", "atencion_salud_covid_tipo",
"pandemia_responsabilidad_control", "pandemia_dificultades_conectividad",
"pandemia_dificultades_sin_dispositivos",
"pandemia_dificultades_pocos_dispositivos", "pandemia_dificultades_espacio",
"pandemia_dificultades_brecha_digital_tutores", "pandemia_dificultades_economicas",
"pandemia_dificultades_tiempo", "pandemia_dificultades_conectividad_otro",
"pandemia_dificultades_sin_dispositivos", 
"pandemia_dificultades_pocos_dispositivos", "pandemia_dificultades_espacio",
"pandemia_dificultades_brecha_digital_tutores", "pandemia_dificultades_economicas",
"pandemia_dificultades_tiempo", "pandemia_dificultades_conectividad_otro")
...
datos = rename(datos,
               ...
               empleo_en_pandemia = "7.5 Durante el aislamiento social por la pandemia, ?qu? paso mayormente con el trabajo de los miembros de su hogar?",
               ...
               conformidad_laboral_pre_pandemia = "8.3 Antes de la pandemia, ¿cuán conforme estaba con la situaci?n laboral de los miembros de su hogar?",
               ...
               difultad_actividades_pandemia = "9.2 Si tuviera que describir  cómo le resultó sobrellevar las  actividades laborales, dom?sticas, de cuidado de personas y acompa?amiento escolar de hijxs en el ?ltimo a?o",
               ...
               atencion_salud_dificultades_pre_pandemia_detalle = "12.3 Voy a leerle algunas dificultades que podrían haber aparecido al momento de buscar atenci?n m?dica, y le voy a pedir que me se?ale todas aquellas que hayan vivido en su núcleo familiar durante el año pasado:",
               ...
               atencion_salud_acceso_informacion = "13.1  ¿Considera que tuvo informaci?n suficiente sobre los programas y servicios de salud durante la cuarentena? (leer opciones)",
               ...
               educ_hogar_secundario_distancia = "14.3 ?Nos podr?a indicar a qué distancia aproximada (en cuadras) de su hogar se ubica el establecimiento? [Secundario]",
               ...
               educ_hogar_inicial_movilidad = "14.2	Para llevar o traer a los niños al jardín, lo hacen 14.3	Para llevar o traer los niños a la escuela... 14.4	Para ir al secundario 14.5	Para ir a la Universidad o terciario (s?lo leer el nivel escolar que corresponda y leer las opciones) [Pre escolar]",
               ...
               educ_hogar_universitario_medios = "1.4.5	¿Nos podría indicar a trav?s de qué medios se realizó esa continuidad? [Universitario o terciario]",
               informacion_medidas_educativas_valoracion = "16.1 Durante la vigencia del aislamiento, ¿considera que la informaci?n obtenida sobre las medidas educativas en relaci?n a los miembros de su hogar fue...?",
               ...
               cant_estudia = "Cuantas personas están cursando algún nivel educativo actualmente?",
               ...
               pandemia_dificultades_economicas = "15.1 Ahora le voy a preguntar sobre las dificultades que hubo en su hogar para sostener la continuidad educativa durante la virtualidad. ¿Tuvieron alguna de estas dificultades? [15.1.6 Dificultades econ?micas para sostener cuotas escolares - Si - No]",
               pandemia_dificultades_tiempo = "15.1 Ahora le voy a preguntar sobre las dificultades que hubo en su hogar para sostener la continuidad educativa durante la virtualidad. ¿Tuvieron alguna de estas dificultades? [15.1.7 Dificultades de tiempo de los adultos para acompa?ar a los estudiantes del hogar - Si - No]",

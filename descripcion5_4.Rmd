  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Alcance de la cobertura de salud","(porcentajes según zona geográfica)")),  1, width="5cm"),
...
tabla_alcance_cobertura_salud_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Alcance de la cobertura de salud según zona geográfica (absolutos)"), latex_options = "HOLD_position") %>% column_spec(1, width = "10em")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Origen del acceso a la información sobre salud","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_atencion_salud_acceso_informacion_origen_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Origen del acceso a la información sobre salud según zona geográfica (absolutos)"), latex_options = "HOLD_position") %>%  column_spec(1, width = "10em")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Dificultades en el acceso a la salud antes de la pandemia","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_atencion_salud_dificultades_pre_pandemia_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Dificultades en el acceso a la salud antes de la pandemia según zona geográfica (absolutos)"), latex_options = "HOLD_position") %>% column_spec(1, width = "10em")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Tipo de cobertura de salud","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")

tabla_cobertura_salud_abs = kable_styling(kable(addmargins(table(
  tabla_cobertura_salud$value, tabla_cobertura_salud$nse)),
  caption = "Tipo de cobertura de salud según zona geográfica (absolutos)"), latex_options = "HOLD_position")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Dificultades en el acceso a la salud en caso de Covid-19 positivo","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_covid_positivo_dificultades_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Dificultades en el acceso a la salud en caso de Covid-19 positivo según zona geográfica (absolutos)"), latex_options = "HOLD_position") %>% column_spec(1, width = "10em")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Fuente de ingresos del hogar","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")

tabla_fuente_ingresos_abs = kable_styling(kable(addmargins(table(
  tabla_fuente_ingresos$value, tabla_fuente_ingresos$nse)),
  caption = "Fuente de ingresos del hogar según zona geográfica (absolutos)"), latex_options = "HOLD_position")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Fuentes de información sobre medidas educativas","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_informacion_medidas_educativas_origen_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Fuentes de información sobre medidas educativas según zona geográfica (absolutos)")) %>% column_spec(1, width = "10em")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Origen del ingreso principal de los hogares","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_origen_ingreso_principal_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Origen del ingreso principal de los hogares según zona geográfica (absolutos)"), latex_options = "HOLD_position")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Prestaciones estatales recibidas","(porcentajes según zona geográfica)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_prestaciones_estatales_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Prestaciones estatales recibidas según zona geográfica (absolutos)"), latex_options = "HOLD_position")
  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Solicitud de ayuda en Pandemia","(porcentajes según zona geográfica)"),longtable = T, booktabs = T),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_solicitud_ayuda_pandemia_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Solicitud de ayuda en Pandemia según zona geográfica (absolutos)", longtable = T, booktabs = T), latex_options = "HOLD_position")
...
datos$hogar_con_covid<-
  as.factor(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`)
levels(datos$hogar_con_covid)<-c("no", "si")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`1.2 Género`, datos$nse),2),2),1),3), caption = "Género de la persona que respondió (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`1.2 Género`, datos$nse)), caption = "Género de la persona que respondió según zona geográfica (absolutos)"), latex_options = "HOLD_position")



kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`1.4 Procedencia`, datos$nse),2),2),1),3), caption = "Lugar de nacimiento de la persona que respondió (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`1.4 Procedencia`, datos$nse)), caption = "Lugar de nacimiento de la persona que respondió según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos_jp$sexo_aportante, datos_jp$nse),2),2),1),3), caption = "Sexo del principal aportante de ingresos del hogar (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(cantidad_de_integrantes, caption = "Media y mediana de la cantidad de integrantes del hogar según zona geográfica"), latex_options = "HOLD_position")


```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`Cuántas son menores de 14 años?`, datos$nse),2),2),1),3), caption = "Cantidad de menores de 14 años en el hogar (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`Cuántas son menores de 14 años?`, datos$nse)), caption = "Cantidad de menores de 14 años en el hogar según zona geográfica (absolutos)"), latex_options = "HOLD_position")


kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$composicion, datos$nse),2),2),1),3), caption = "Composición de los hogares por tamaño y grupos de edades (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$composicion, datos$nse)), caption = "Composición de los hogares por tamaño y grupos de edades según zona geográfica (absolutos)"), latex_options = "HOLD_position")



kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$composicion_edad, datos$nse),2),2),1),3), caption = "Composición de los hogares por grupos de edades convivientes (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$composicion_edad, datos$nse)), caption = "Composición de los hogares por grupos de edades convivientes según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(
  addmargins(
    prop.table(
      addmargins(
        table(
          datos$hacinamiento_critico, datos$nse),2),2),1),3), caption = "Hogares con hacinamiento crítico (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$hacinamiento_critico, datos$nse)), caption = "Hogares con hacinamiento crítico (absolutos según zona geográfica)"), latex_options = "HOLD_position")
```


```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`La vivienda de su casa cuenta con [Cloacas]`, datos$nse),2),2),1),3), caption = "Servicio de cloacas en la vivienda según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`La vivienda de su casa cuenta con [Cloacas]`, datos$nse)), caption = "Servicio de cloacas en la vivienda según zona geográfica (absolutos)"), latex_options = "HOLD_position")


kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`La vivienda de su casa cuenta con [Gas Natural]`, datos$nse),2),2),1),3), caption = "Servicio de gas natural en la vivienda según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`La vivienda de su casa cuenta con [Gas Natural]`, datos$nse)), caption = "Servicio de gas natural en la vivienda según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(electronicos, caption = "Existencia de dispositivos electrónicos en el hogar, porcentaje según zona geográfica"), latex_options = "HOLD_position")
```
...
kable_styling(kable(100*round(addmargins(prop.table(
  addmargins(table(
    datos$tipo_conexion, datos$nse),2),2),1),3), caption = "Tipo de conexión a Internet  en el hogar según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")


kable_styling(kable(addmargins(table(datos$tipo_conexion, datos$nse)
), caption = "Tipo de conexión a Internet en el hogar según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```
...
kable_styling(kable(atencion_rel, caption = "Lugar de atención ante problemas de salud (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")


kable_styling(kable(atencion_abs, caption = "Lugar de atención ante problemas de salud (cantidad absoluta de respuestas según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`10.2 Nos podría indicar a qué distancia aproximada de su casa (en cuadras) se ubica el centro de salud que utiliza?`, datos$nse),2),2),1),3), caption = "Distancia desde el domicilio hasta el centro de salud (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`10.2 Nos podría indicar a qué distancia aproximada de su casa (en cuadras) se ubica el centro de salud que utiliza?`, datos$nse)), caption = "Distancia desde el domicilio hasta el centro de salud según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```
...
kable_styling(column_spec(kable(100*round(addmargins(prop.table(addmargins(table(datos$`10.3 Cuando necesita atención médica, Ud o su familia se dirigen a ese centro de salud:`, datos$nse),2),2),1),3), caption = "Medio de transporte para concurrir al centro de salud (porcentajes según zona geográfica)"), 1, width="5cm"), latex_options = "HOLD_position")
kable_styling(column_spec(kable(addmargins(table(datos$`10.3 Cuando necesita atención médica, Ud o su familia se dirigen a ese centro de salud:`, datos$nse)), caption = "Medio de transporte para concurrir al centro de salud según zona geográfica (absolutos)"), 1, width="5cm"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14.3 ¿Nos podría indicar a qué distancia aproximada (en cuadras) de su hogar se ubica el establecimiento? [Pre escolar]`, datos$nse),2),2),1),3), caption = "Distancia establecimiento preescolar (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`14.3 ¿Nos podría indicar a qué distancia aproximada (en cuadras) de su hogar se ubica el establecimiento? [Pre escolar]`, datos$nse)), caption = "Distancia establecimiento preescolar según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```


```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Jardín de infantes]`, datos$nse),2),2),1),3), caption = "Integrantes cursando jardín de infantes (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Jardín de infantes]`, datos$nse)), caption = "Integrantes cursando jardín de infantes según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Primario]`, datos$nse),2),2),1),3), caption = "Integrantes cursando primario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Primario]`, datos$nse)), caption = "Integrantes cursando primario según zona geográfica (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Secundario]`, datos$nse),2),2),1),3), caption = "Integrantes cursando secundario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Secundario]`, datos$nse)), caption = "Integrantes cursando secundario según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Universitario o terciario]`, datos$nse),2),2),1),3), caption = "Integrantes cursando universitario o terciario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`14. En su hogar hay integrantes cursando [Universitario o terciario]`, datos$nse)), caption = "Integrantes cursando universitario o terciario según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$ingreso, datos$nse),2),2),1),3), caption = "Ingresos del hogar según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$ingreso, datos$nse)), caption = "Ingresos del hogar según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(fuente_de_ingresos_rel, caption = "Fuentes de ingresos del hogar (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")

```


```{r}
kable_styling(kable(fuente_de_ingresos_abs, caption = "Fuentes de ingresos del hogar (cantidad de respuestas según zona geográfica)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(fuente_de_ingresos_ppal_rel, caption = "Fuentes de los ingresos principales del hogar (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(fuente_de_ingresos_ppal_abs, caption = "Fuentes de los ingresos principales del hogar (cantidad de respuestas según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$tipo_trabajo, datos$nse),2),2),1),3), caption = "Tipo de trabajo según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$tipo_trabajo, datos$nse)), caption = "Tipo de trabajo según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(cobertura_salud_porc, caption = "Porcentaje de hogares en los que al menos uno de los integrantes tiene... según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(cobertura_salud, caption = "Cantidad de hogares en los que al menos uno de los integrantes tiene... según zona geográfica"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$emergencia, datos$nse),2),2),1),3), caption = "Disponibilidad de servicio médico de emergencia a domicilio (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$emergencia, datos$nse)), caption = "Disponibilidad de servicio médico de emergencia a domicilio según zona geográfica (absolutos)"), latex_options = "HOLD_position")


kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$ambulancia, datos$nse),2),2),1),3), caption = "Disponibilidad de servicio de ambulancia en caso de urgencia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$ambulancia, datos$nse)), caption = "Disponibilidad de servicio de ambulancia en caso de urgencia  según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$suficiencia_ingresos_antes, datos$nse),2),2),1),3), caption = "Ingresos antes de la pandemia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$suficiencia_ingresos_ahora, datos$nse),2),2),1),3), caption = "Ingresos en pandemia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$cambio_ingresos, datos$nse),2),2),1),3), caption = "Cambios sufridos en los ingresos del hogar según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$cambio_ingresos, datos$nse)), caption = "Cambios sufridos en los ingresos del hogar según zona geográfica (absolutos)"), latex_options = "HOLD_position")


kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$conformidad_trabajo_antes, datos$nse),2),2),1),3), caption = "Trabajo de los integrantes del hogar antes de la pandemia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$conformidad_trabajo_ahora, datos$nse),2),2),1),3), caption = "Cambios en el trabajo de los integrantes del hogar en pandemia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.1 Durante la pandemia, ¿Ud o su familia tuvieron problemas de salud que demandaran atención médica?`, datos$nse),2),2),1),3), caption = "Necesidad de atención médica durante la pandemia (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`12.1 Durante la pandemia, ¿Ud o su familia tuvieron problemas de salud que demandaran atención médica?`, datos$nse)), caption = "Necesidad de atención médica durante la pandemia según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.2. Y en ese contexto, ¿tuvieron dificultades para acceder a los servicios de salud?`, datos$nse),2),2),1),3), caption = "Dificultad de acceso a servicios de salud (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`12.2. Y en ese contexto, ¿tuvieron dificultades para acceder a los servicios de salud?`, datos$nse)), caption = "Dificultad de acceso a servicios de salud según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$nse),2),2),1),3), caption = "Algún integrante tuvo COVID (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$nse)), caption = "Algún integrante tuvo COVID según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$`La vivienda de su casa cuenta con [Agua potable]`),2),2),1),3), caption = "Algún integrante tuvo COVID (porcentajes según disponibilidad de agua potable)"), latex_options = "HOLD_position")


kable_styling(kable(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$`La vivienda de su casa cuenta con [Agua potable]`)), caption = "Algún integrante tuvo COVID según disponibilidad de agua potable (absolutos)"), latex_options = "HOLD_position")

kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$`La vivienda de su casa cuenta con [Cloacas]`),2),2),1),3), caption = "Algún integrante tuvo COVID (porcentajes según disponibilidad de cloacas)"), latex_options = "HOLD_position")


kable_styling(kable(addmargins(table(datos$`12.4 ¿Algún integrante de su familia tuvo COVID19?`, datos$`La vivienda de su casa cuenta con [Cloacas]`)), caption = "Algún integrante tuvo COVID según disponibilidad de cloacas (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`12.5 Ante los síntomas de la enfermedad, a dónde  se atendieron?`, datos$nse),2),2),1),3), caption = "Lugar de atención ante síntomas COVID (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`12.5 Ante los síntomas de la enfermedad, a dónde  se atendieron?`, datos$nse)), caption = "Lugar de atención ante síntomas COVID según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Pre escolar]`, datos$nse),2),2),1),3), caption = "Continuidad educativa durante la pandemia, preescolar (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Pre escolar]`, datos$nse)), caption = "Continuidad educativa durante la pandemia, preescolar según zona geográfica (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Primario]`, datos$nse),2),2),1),3), caption = "Continuidad educativa durante la pandemia, primario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Primario]`, datos$nse)), caption = "Continuidad educativa durante la pandemia, primario según zona geográfica (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Secundario]`, datos$nse),2),2),1),3), caption = "Continuidad educativa durante la pandemia, secundario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Secundario]`, datos$nse)), caption = "Continuidad educativa durante la pandemia, secundario según zona geográfica (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Terciario o universitario]`, datos$nse),2),2),1),3), caption = "Continuidad educativa durante la pandemia, terciario o universitario (porcentajes según zona geográfica)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`14.6. Durante la pandemia¿ qué tipo de  continuidad educativa tuvieron? [Terciario o universitario]`, datos$nse)), caption = "Continuidad educativa durante la pandemia, terciario o universitario según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(u, caption = "Dificultades para sostener la continuidad educativa durante la virtualidad (porcentaje de afectados según zona geográfica) "), latex_options = "HOLD_position")
...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$prestacion_estatal, datos$nse),2),2),1),3), caption = "Percepción de prestaciones según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")
```


```{r}
kable_styling(kable(addmargins(table(datos$prestacion_estatal, datos$nse)), caption = "Percepción de prestaciones según zona geográfica (absolutos)"), latex_options = "HOLD_position")
```
...
kable_styling(kable(prestaciones,
      caption = "Prestaciones estatales percibidas por integrantes del hogar durante el último mes (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")
```
...
kable_styling(kable(credito,
      caption = "Opciones de crédito y financiación usadas durante la pandemia (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")
...
kable_styling(kable(100*round(addmargins(prop.table(
  addmargins(table(
    datos$mejora_acceso_internet, datos$nse),2),2),1),3), caption = "Adquisición de nuevos paquetes o mejora en la conectividad a Internet en el último año según zona geográfica (porcentajes según zona geográfica)"), latex_options = "HOLD_position")


kable_styling(kable(addmargins(table(datos$mejora_acceso_internet, datos$nse)
), caption = "Adquisición de nuevos paquetes o mejora en la conectividad a Internet en el último año según zona geográfica (absolutos)"), latex_options = "HOLD_position")
...
kable_styling(kable(trabajo_pandemia, caption = "Características del trabajo durante la pandemia (porcentajes de respuestas según zona geográfica)"), latex_options = "HOLD_position")
```
...
tabla_covid_positivo_dificultades_rel
tabla_covid_positivo_dificultades_abs

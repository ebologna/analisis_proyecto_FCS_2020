...
datos_jp$X = NULL
datos_jp$nse = ifelse(datos_jp$nse=="Alto","A",
                      ifelse(datos_jp$nse=="Medio alto","B",
                             ifelse(datos_jp$nse=="Medio","C",
                                    ifelse(datos_jp$nse=="Medio Bajo","D","E"))))
datos_jp$nse = as.factor(datos_jp$nse)
```
...
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`1.2 Género`, datos$nse),2),2),1),3), caption = "Género de la persona que respondió (porcentajes según zona geográfica)", digits = 2), latex_options = "HOLD_position")

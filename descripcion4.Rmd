...
```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [PC de escritorio]`, datos$nse)
,2),2),1),3), caption = "Existencia de PC en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")

kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [PC de escritorio]`, datos$nse)
), caption = "Existencia de PC en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Notebook]`, datos$nse)
,2),2),1),3), caption = "Existencia de notebook en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Notebook]`, datos$nse)
), caption = "Existencia de notebook en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")

```


```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Notebook de Conectar Igualdad]`, datos$nse)
,2),2),1),3), caption = "Existencia de notebook de Conectar Igualdad en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Notebook de Conectar Igualdad]`, datos$nse)
), caption = "Existencia de notebook de Conectar Igualdad en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")

```


```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Tablet / Ipad]`, datos$nse)
,2),2),1),3), caption = "Existencia de tablet o Ipad en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Tablet / Ipad]`, datos$nse)
), caption = "Existencia de tablet o Ipad en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")

```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Impresora]`, datos$nse)
,2),2),1),3), caption = "Existencia de impresora en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Impresora]`, datos$nse)
), caption = "Existencia de impresora en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")
```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Smart TV]`, datos$nse)
,2),2),1),3), caption = "Existencia de smart TV en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Smart TV]`, datos$nse)
), caption = "Existencia de smart TV en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")
```

```{r}
kable_styling(kable(100*round(addmargins(prop.table(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Cámara de fotos]`, datos$nse)
,2),2),1),3), caption = "Existencia de cámara de fotos en el hogar según NSE (porcentajes por NSE)"), latex_options = "HOLD_position")
kable_styling(kable(addmargins(table(datos$`5.1 En su hogar, tienen alguno de los dispositivos tecnológicos que voy a nombrarle? [Cámara de fotos]`, datos$nse)
), caption = "Existencia de cámara de fotos en el hogar según NSE (absolutos)"), latex_options = "HOLD_position")
```
...
datos$celulares_cada_mayor_14[
  datos$celulares_cada_mayor_14==Inf
]<-NA

celulares_por_persona<-datos %>%
  group_by(nse) %>%
  summarise(promedio=round(mean(celulares_cada_mayor_14, na.rm=TRUE),2))
names(celulares_por_persona)<-c("Nivel socioeconómico", "Celulares por persona")
kable_styling(kable(celulares_por_persona, caption = "Número promedio de celulares en el hogar por perona mayor de 14 años"), latex_options = "HOLD_position")

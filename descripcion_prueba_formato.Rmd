  ...
  addmargins(
    prop.table(
      addmargins(
        ...
        2),2),1),3),
  caption = paste("Dificultades en el acceso a la salud en caso de Covid-19 positivo","(porcentajes por NSE)")),  1, width="5cm"),
  latex_options = "HOLD_position")
...
tabla_informacion_medidas_educativas_origen_abs = kable_styling(kable(addmargins(table(
  ...
  caption = "Fuentes de información sobre medidas educativas según NSE (absolutos)", longtable = T, booktabs = T)) %>% column_spec(1, width = "10em")
...
## Composicion y características de los hogares  
...
```{r}
table(datos$ambulancia, datos$nse)
